...
This layer gives Huwam a first real place to store gold, experience, and quest progress.
...
| `UHuwamRewardComponent` | Stores gold, experience, and quest progress. |
...
| Value | Purpose |
|---|---|
| GoldBalance | Spendable gold owned by the character. |
...
5. Reward component adds gold and experience.
...
- Grant the quest's own gold reward after turn-in.
